      ...
      Ladder: [
        {
          'Dan 1': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Being not self-motivated; needing someone to tell you what to do next',
              ...
              },
              {
                ...
                remedy:
                  "Learn the team's processes well before criticizing; they're ofter there for a reason"
              },
              {
                'anti-pattern':
                  'Working on too many things at once, not getting the important stuff done',
                remedy:
                  'Focus on one thing at a time, and do it well, then move on'
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 2': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Failing to identify or communicate big roadblocks',
                remedy: 'Raise red flags early;  get unstuck quickly'
              },
              {
                'anti-pattern': 'Not taking operational excellence seriously',
                remedy:
                  "Consider that you're setting an example for more junior devs; be proud of your work"
              },
              {
                'anti-pattern':
                  'Providing solutions that are more complicated than necessary',
                remedy:
                  "There's beauty in simplicity and elegance; tried and tested is often better than the new shiny toy"
              },
              {
                'anti-pattern':
                  'Preferring shallow progress over an in-depth understanding of code and context',
                remedy:
                  "You should be expanding your context and understanding; it might not seem so at the moment, but they'll server you much better later down the line that a quick win now"
              },
              {
                'anti-pattern':
                  'Preferring patching symptoms rather than mitigating the core issue',
                remedy:
                  'Spend 2x time now to actually fix the problem, to save 10x time later when the bug reappears'
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                name: 'Release It!',
                link:
                  'https://www.amazon.com/Release-Design-Deploy-Production-Ready-Software-dp-1680502395/dp/1680502395/'
              },
              {
                type: 'book',
        ...
        },
        {
          'Dan 3': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Not delegating. Always saying \u201cyes\u201d and suffer from burn-out or continuous loss of focus',
                remedy:
                  "Be mindful of your time and previous engagements; don't spread yourself too thin"
              },
              {
                'anti-pattern': 'Letting details slip through the cracks',
                remedy:
                  "At your level of engineering competence, you're expected to be meticulous in your craft"
              },
              {
                'anti-pattern':
                  'Over-emphasizing scaling or high availability far beyond the requirements (project/business needs)',
                remedy:
                  'While being mindful of scale and HA is important, sometimes a naive solution is good enough, and is able to get you up and running quickly'
              },
              {
                'anti-pattern':
                  'Preferring local solutions to more global problems, especially if a problem is an obvious issue to multiple teams',
                remedy:
                  "Always think about the impact you're making; focusing only on your immediate surroundings limits the extent of your potential impact"
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 4': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Forcing your opinion (potentially abusing your "title") without giving enough attention to tradeoffs and hearing others',
                remedy:
                  'Be mindful of the fact that you can also be wrong, and never browbeat others; lead by conviction, not fear'
              },
              {
                'anti-pattern':
                  'Focusing only on 1-2 teams or areas, instead of looking at the bigger picture (long-term horizon)',
                remedy:
                  "You're expected to be impacting multiple teams and areas; see where you can use your skill-set for maximum impact"
              },
              {
                'anti-pattern':
                  'Giving up too quickly when trying to convince people (e.g. multiple teams, many opinions) due to high friction',
                remedy:
                  "People will inevitably disagree with you. That's ok. Consider their objections, but if you believe you're in the right, work harder on convincing them"
              },
              {
                'anti-pattern':
                  "Falling in love with the solution instead of the problem. Be unable adopt others' opinions and execute on them.",
                remedy:
                  "There's usually nothing magical about your preferred solution; consider that there may be many equally good solutions to a problem. If others prefer and equally viable solution, it might be better to adopt it than digging in and defending yours"
              },
              {
                'anti-pattern':
                  'Building solutions that are too \u201cshort-term\u201d oriented or not robust enough',
                remedy:
                  'Spend more time when gather requirements to enrich them, and make the final solution more robust'
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 5': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Acting only from a technical viewpoint, without considering the business needs or needed impact (e.g. coming up with suggestions that might not be relevant for the company in the next 12-18 months)',
                remedy:
                  "At your level, architectural decisions have vast implications; you should always be thinking on long term impact that's aligned with the company's business needs"
              },
              {
                'anti-pattern':
                  'Not investing time to come up with concrete vision and ideas for improving the way we work',
                remedy:
                  'You\'re expected to be able to present a coherent articulation of your ideas, not just vague statements about "making things better"'
              },
              {
                'anti-pattern':
                  'Focusing only on R&D, without trying to understand the impact on other groups (where applicable)',
                remedy:
                  'Try to expand your horizons across department lines; your decisions likely affect other departments as well \u2014\u00a0be mindful of it'
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                link:
                  'https://margint.blog/2020/10/07/some-thoughts-on-the-principal-role/'
              },
              {
                type: 'article',
      ...
      Ladder: [
        {
          'Dan 1': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Moving to writing code too quickly, without first fully scoping the effort/project',
                remedy:
                  "Make sure you know what you're going to do before starting coding; this will help you avoid having to backtrack later"
              },
              {
                'anti-pattern':
                  'Avoiding raising a flag when stuck on the same problem for too long',
                remedy:
                  "Don't be afraid to ask for help; while some determination is commendable, don't waste too much time on a problem that someone else has already solves"
              },
              {
                'anti-pattern':
                  'Failing to report on progress in a timely manner ("going dark")',
                remedy:
                  'Almost always prefer "push" to "pull" communications; letting others know where you stand on a task is a sure sign of ability and confidence'
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                link:
                  'https://docs.google.com/presentation/d/17K27cBs_dRnW512tJrewP25AHpiUPt7JxUcxjgSxSjs/mobilepresent?slide=id.g1f5fb32513_2_45'
              }
            ]
          }
        },
            ...
            'Anti-Patterns': [
              {
                ...
                remedy:
                  'As the owner of a project, the buck stops with you; be confident that others will recognize when a delay is not your fault, but still take responsibility for it'
              },
              {
                'anti-pattern':
                  'Getting stuck on unimportant details; not utilize the 80-20 rule',
                remedy:
                  'Some parts of the project bring most of its value; focus on those first and foremost, before moving on to polishing touches'
              },
              {
                'anti-pattern':
                  'Not communicating progress related to the project',
                remedy:
                  'Regardless of whether the lack of progress is due to you or others, a steady stream of communications is imperative to let your superiors know where the project stands'
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 3': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Rushing to work on the solution before gathering and understanding business/analytical/technical needs',
                remedy:
                  'Time spent planning is payed back tenfold during execution'
              },
              {
                'anti-pattern':
                  'Not stating clearly risks in a project and the way they will be mitigated',
                remedy:
                  'Risk mitigation is arguably the most important part of a Design Review; be sure to address risks early and with detail'
              },
              {
                'anti-pattern':
                  'Being unable to lead other teammates in the project. Having problems with e.g. delegation, tasks assignment, solving roadblocks, communications around progress, etc.',
                remedy:
                  "Understand that there's only so much you can do on your own. The mark of a good leader is being able to work with others"
              },
              {
                'anti-pattern':
                  'Not pushing back (and providing alternatives and justifications) on requirements that might add risk, add a lot of time to the project or make it extremely hard to maintain it in the long run',
                remedy:
                  'Taking ownership of a project means accepting responsibility for it; not pushing back on risky requirements is a sure way to end up with a project you hate supporting'
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 4': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Struggling to raise flags and find alternative solutions when a teammate or a dependency is not keeping up, either in terms of quality or availability',
                remedy:
                  'Learn to think on your feet. Circumstances change, and you should be able to adapt, whether by redirecting manpower, changing requirements, delaying the project, or any other means'
              },
              {
                'anti-pattern':
                  'Avoiding confrontations \u2014 struggling to resolve disagreements, explicitly stating your needs, etc.',
                remedy:
                  "Confrontations are inevitable, so it'll be nigh impossible to completely avoid them. Be sure you know *exactly* what the disagreement is about; it might be much smaller than it seems"
              },
              {
                'anti-pattern':
                  'Trying to achieve too many things on your own, instead of relying on others around your \u2014 either by asking help or delegating tasks',
                remedy:
                  "Hopefully, you're surrounded by other competent people \u2014\u00a0take advantage of that fact, and work with them :)"
              },
              {
                'anti-pattern':
                  'Inadvertently suppressing innovation from other engineers (e.g. by giving your own ideas first and loudest, criticizing without truly listening to new ideas or by giving the impression that there is only one right solution to a problem)',
                remedy:
                  'Be open to others, especially the more junior engineers; remember that you yourself was once a smart junior :)'
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                link:
                  'https://www.amazon.com/Leading-Without-Authority-Co-Elevation-Collaboration/dp/0525575669/'
              },
              {
                type: 'article',
        ...
        },
        {
          'Dan 5': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Letting friction (disagreements, unclear requirements) stall the project and kill momentum for the team that works on it. Not leading others well, leaving them feeling lost and unsure of what needs to be done',
                remedy:
                  "There are times when hard decisions need to be made, even if they're not perfect. So long as you're clear on risks, mitigations and tradeoffs, it's to push an imperfect solution"
              },
              {
                'anti-pattern':
                  'Avoiding presenting dilemmas, tradeoffs and taking an active part in making a decision in a timely manner. Waiting for others to make the decision',
                remedy:
                  "As a principal engineer, you'll often be the most senior person working on a project. No one else will decide on the way forward for you on those occasions"
              }
            ],
            Resources: [
              {
                ...
                link:
                  'http://www.tombartel.de//2016/02/15/right-level-of-abstraction/'
              },
              {
                type: 'article',
                name:
      ...
      Ladder: [
        {
          'Dan 1': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Having a "code-monkey" mindset \u2014 knowing how to deliver features but not being able to explain or not caring why they\'re worth doing',
                remedy:
                  "You'll find your work much more satisfying and meaningful if you're able to articulate the business needs of the features you're working on"
              },
              {
                'anti-pattern':
                  'Looking "down" on other departments (outside of Engineering) \u2014 not understanding their work, thus discounting their needs/pains/contributions',
                remedy:
                  'Having strong engineers does not mean having a successful company; trust that the same people that collected great engineers also put thought into hiring amazing people in other departments'
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 2': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Promoting ideas with purely technical merit, discounting business justifications',
                remedy:
                  "Your superiors aren't likely to greenlight such projects, which will leave you frustrated. Start from business needs, not tech; you can always choose cool tech once you know what the needs are (if applicable)"
              },
              {
                'anti-pattern':
                  'Not considering or verifying costs when suggesting new ideas',
                remedy:
                  "Cost is one of the first factors experienced devs and managers consider, so before advancing a new idea, make sure you have a rough idea of how much it'll cost"
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 3': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Not spending enough time to document proper pains & suggestions, keeping it all in your head and relying only on your memory',
                remedy:
                  "Others won't be able to act to whatever you keep in your head; documenting and sharing your insights is a crucial part of having them"
              },
              {
                'anti-pattern':
                  "Spending too much of your time focusing on the team and the team's needs, instead of trying to increase your impact circle with other teams around you",
                remedy:
                  'One of the greatest benefits that come from increasing your understanding of the business, is the ability to increase the radius of your impact'
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                link:
                  'https://blog.coleadership.com/how-to-get-buy-in-for-reducing-technical-debt/'
              }
            ]
          }
        },
        {
          'Dan 4': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Letting things live in a "limbo" for complicated domains (where ownership is a bit fluid). Being passive or unclear about time estimations, or making excuses on why we\'ve reached this state',
                remedy:
                  'As they say, "with great power comes great responsibility". Consider stepping up and taking ownership of domains that other aren\'t willing to'
              },
              {
                'anti-pattern':
                  'Not creating momentum in areas you lead - waiting for someone else to pick it up for you (e.g. your manager)',
                remedy:
                  'Being senior enough to lead an area implies trust from your manager. They need to know that you can be relied upon. Prove them right.'
              },
              {
                'anti-pattern':
                  'Acting as an owner (design & decision making) but avoiding the responsibility that comes with it (i.e. continuously supporting and pushing it forward)',
                remedy:
                  "Many engineers enjoy hacking, but don't enjoy maintenance as much. Often, though, a less flashy but well maintained product is much more valuable than an exciting new one that's hacked together but then left half finished"
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 5': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Struggling to build good working relationships with the Team and Tech Leaders in the group, impacting their ability to initiate cross-team projects',
                remedy:
                  'Good relationships often matter more than technical know-how. Try to cultivate, it not friendship, then at least good working relationships with the other leading devs and managers in your area'
              },
              {
                'anti-pattern':
                  'Being unable to translate your vast tech knowledge to the managerial level, making it harder for management to understand your value or why you should have a seat at the table',
                remedy:
                  "Clear articulation will often get you farther when communicating with non-technical management than the technical knowledge itself. You need to cultivate this ability in you, or you won't be able to get buy-in on the really large/important projects"
              }
            ],
            Resources: [
              {
                ...
                link:
                  'https://businessofsoftware.org/2016/06/scaling-a-technology-business-is-about-unscaling-technical-debt-tall-jeff-stack-exchange-bos-usa-2015/'
              },
              {
                type: 'book',
                name:
      ...
      Ladder: [
        {
          'Dan 1': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  "Being unwilling to join a team's efforts when not part of the task/project",
                remedy:
                  'While some project might not be immediately related to your current task, try to learn from others working on it nonetheless'
              },
              {
                'anti-pattern':
                  'Asking the same questions or demonstrating a lack of knowledge-gathering due to "laziness" (e.g. not writing things after being taught them)',
                remedy:
                  'Asking questions is encouraged; asking the same questions signals an unwillingness to learn. Consider writing down whatever you learn'
              },
              {
                'anti-pattern':
                  'Having a "lone wolf" attitude \u2014 not seeking to interact with others, in and outside the team',
                remedy:
                  "Eventually you'll have to work with others in and outside the team. There's only so far you'll be able to get on your own"
              }
            ],
            Resources: [
              {
        ...
        },
        {
          'Dan 2': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  "Feeling comfortable with not taking a fair share of the team's operations (or any other burden)",
                remedy:
                  'Earning the ire of others on the team is never a great way to progress'
              },
              {
                'anti-pattern':
                  "Talking behind teammates' backs instead of trying to resolve issues directly",
                remedy:
                  "Hashing your difficulties with others might seem scary in the short term, but long-term it's the only way to foster trust and a good relationship"
              },
              {
                'anti-pattern':
                  'Being difficult to work with due to the "high tax" people need to pay to provide feedback \u2014 always arguing instead of asking more questions, not taking responsibility, etc.',
                remedy:
                  "If you make it difficult to give you feedback, people will stop trying and you'll stagnate. Try seeing feedback not as saying anything about your as a person, but rather as a way to improve in an area you have less visibility in"
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                link:
                  'https://keen.io/blog/how-to-give-and-receive-effective-feedback/'
              }
            ]
          }
        },
        {
          'Dan 3': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Being unwilling to bend to the team\'s needs. Focusing only on the ideal ("pure") solution and neglecting adoption and other considerations',
                remedy:
                  'Sometimes legacy/cost/know-how considerations make it better to choose a solution that\'s less "perfect" in theory, but actually better for the team'
              },
              {
                'anti-pattern':
                  'Talking down to people, making them feel insecure',
                remedy:
                  "Just don't. People will resent and avoid you if you do that"
              },
              {
                'anti-pattern':
                  'Taking credit for work done in cooperation with others (especially less experienced team members)',
                remedy:
                  'Always highlight the "team effort" aspect of projects. Remember that you once needed this extra push yourself'
              }
            ],
            Resources: [
              {
              ...
              },
              {
                ...
                link:
                  'https://www.effectiveengineer.com/blog/hidden-costs-that-engineers-ignore'
              },
              {
                type: 'book',
                name: 'How to Have Impossible Conversations',
                link:
                  'https://www.amazon.com/How-Have-Impossible-Conversations-Practical-dp-0738285323/dp/0738285323/'
              },
              {
                type: 'article',
        ...
        },
        {
          'Dan 4': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  "Being only concerned with delivery without considering the pains and needs of the team. Not investing time to discuss areas of pain with the team's manager. Not thinking about increasing the team's velocity or happiness",
                remedy:
                  "Increasing the team's velocity is often a much better long-term investment of your time then working on your task, since it improves the performance of many people"
              },
              {
                'anti-pattern':
                  "Demonstrating immaturity when speaking about the team's process, tools or problems with other teams or people outside of the organization. Being a judge and a (gossip) reporter instead of an owner",
                remedy:
                  "While it's ok to acknowledge issues with your team's offering, badmouthing it in front of other teams is a bad idea. Try to understand the pains others raise, offer suggestions/solutions where applicable, and bring the ideas back to the team"
              },
              {
                'anti-pattern':
                  'Being too quick to rule out ideas or suggestions, without coming up with well-thought alternatives',
                remedy:
                  "Putting down ideas is easier than coming up with them. When ruling out another person's suggestion, consider the original need that sparked it, and see if you can come up with an alternative"
              }
            ],
            Resources: [
              {
                ...
                link:
                  'https://www.wsj.com/articles/SB10001424052702304753504579285133045398344'
              },
              {
                type: 'article',
                name:
        ...
        },
        {
          'Dan 5': {
            ...
            'Anti-Patterns': [
              {
                'anti-pattern':
                  'Only focusing on the pains of the group, while neglecting the needs of the team, which might lead to resentment by the teammates',
                remedy:
                  "While it's a good idea generally to progressively increase the radius of your impact, try not to neglect your team; show that you're still part of it"
              },
              {
                'anti-pattern':
                  'Being passive about promoting the team members and achievements to the group or company',
                remedy:
                  'At this level, you have a loud void; use it to hype people and achievements to those who might not have the opportunity to hear from the more junior devs'
              },
              {
                'anti-pattern':
                  'Creating the impression that big innovative new ideas should only come from Principal Engineers',
                remedy:
                  "This is, simply, wrong. Don't discourage more junior devs from suggesting (and, indeed, implementing) big projects"
              },
              {
                'anti-pattern':
                  'Constantly failing to get buy-in for new initiatives due to lack of proper reasoning behind them (technical and/or business needs). Relying too much on the title',
                remedy:
                  "Being at this level doesn't mean everything you say is automatically accepted by all; you still need to convince people the same way as before"
              },
              {
                'anti-pattern':
                  'Becoming numb to problems because you\u2019ve been living with them for a long time (or convincing yourself that there\u2019s no real problem there)',
                remedy:
                  'The fact that "things have always been like this" doesn\'t make it necessarily a good thing; if you see all new hires voicing their problems with a system/tool/process, take it seriously'
              }
            ],
            Resources: [
              {
